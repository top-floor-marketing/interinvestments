...
class share_agent_plugin_options
{
  ...
  {
    $this->plugin_options_page = add_options_page('share_agent_plugin', 'share_agent_plugin', 'manage_options', __FILE__, array($this, 'render_plugin_options_page'));
  }

  public function render_plugin_options_page()
  {
    echo '<div id="share_agent_plugin"></div>';
  }
...
$share_agent_plugin_options = new share_agent_plugin_options();
$share_agent_plugin_options->init();
