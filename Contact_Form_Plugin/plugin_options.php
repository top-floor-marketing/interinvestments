...
class Contact_Form_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('Contact_Form', 'Contact_Form', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="Contact_Form"></div>';
  }
  ...
  public function enqueue_admin_scripts($hook) {
    ...
    if( $hook === $this->plugin_options_page ) {
      ...
      $handle = 'wp-react-plugin-Contact_Form';
...
$Contact_Form_options = new Contact_Form_options();
$Contact_Form_options->init();