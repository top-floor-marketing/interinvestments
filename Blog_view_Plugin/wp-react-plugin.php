<?php
/*
Plugin Name: Blog_view
Description: Use the [Blog_view] shortcode to display the plugin
Version: 0.0.1
...
function Blog_view_shortcode( $atts ) {
  ...
  return "<div id='Blog_view'></div>";
}

add_shortcode( 'Blog_view', 'Blog_view_shortcode' );
