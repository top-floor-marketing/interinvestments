  ...
  return (
    <Box className={styles.containerCollapse}>
      <Divider
        ...
        data-aos="zoom-in"
      />
      <CollapseContainer delayAnimatio="200" title="Specs" index="01">
        <ContendCollapse data={SpecsData()} />
      </CollapseContainer>
      <CollapseContainer delayAnimatio="200" title="Finishes" index="02">
        <ContendCollapse data={finishesData()} />
      </CollapseContainer>

      <CollapseContainer delayAnimatio="300" title="Floorplans" index="03">
      ...
      <CollapseContainer delayAnimatio="400" title="Team" index="04">
        <ContendCollapse data={TeamData()} />
      </CollapseContainer>
      <CollapseContainer
        delayAnimatio="500"
        title="Downloads"
