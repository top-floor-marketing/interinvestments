...
class Single_Listing_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('Single_Listing', 'Single_Listing', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="Single_Listing"></div>';
  }
  ...
  public function enqueue_admin_scripts($hook) {
    ...
    if( $hook === $this->plugin_options_page ) {
      ...
      $handle = 'wp-react-plugin-Single_Listing';
...
$Single_Listing_options = new Single_Listing_options();
$Single_Listing_options->init();