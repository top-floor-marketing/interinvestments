...
class All_Listing_View_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('All_Listing_View', 'All_Listing_View', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="All_Listing_View"></div>';
  }
  ...
  public function enqueue_admin_scripts($hook) {
    ...
    if( $hook === $this->plugin_options_page ) {
      ...
      $handle = 'wp-react-plugin-All-Listing-View';
...
$All_Listing_View_options = new All_Listing_View_options();
$All_Listing_View_options->init();