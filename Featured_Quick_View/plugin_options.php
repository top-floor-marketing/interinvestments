...
class Featured_Quick_View_options
{
  ...
  {
    $this->plugin_options_page = add_options_page('Featured_Quick_View', 'Featured_Quick_View', 'manage_options', __FILE__, array($this, 'render_plugin_options_page'));
  }

  public function render_plugin_options_page()
  {
    echo '<div id="Featured_Quick_View"></div>';
  }
