...
class Carousel_Blog_options
{
  ...
  {
    $this->plugin_options_page = add_options_page('Carousel_Blog', 'Carousel_Blog', 'manage_options', __FILE__, array($this, 'render_plugin_options_page'));
  }

  public function render_plugin_options_page()
  {
    echo '<div id="Carousel_Blog"></div>';
  }
...
$Carousel_Blog_options = new Carousel_Blog_options();
$Carousel_Blog_options->init();
