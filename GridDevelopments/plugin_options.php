...
class Grid_Developments_options
{
  ...
  {
    $this->plugin_options_page = add_options_page('Grid_Developments', 'Grid_Developments', 'manage_options', __FILE__, array($this, 'render_plugin_options_page'));
  }

  public function render_plugin_options_page()
  {
    echo '<div id="Grid_Developments"></div>';
  }
...
$Grid_Developments_options = new Grid_Developments_options();
$Grid_Developments_options->init();
