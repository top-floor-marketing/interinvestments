...
class Agent_Card_Info_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('Agent_Card_Info', 'Agent_Card_Info', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="Agent_Card_Info"></div>';
  }
  ...
  public function enqueue_admin_scripts($hook) {
    ...
    if( $hook === $this->plugin_options_page ) {
      ...
      $handle = 'wp-react-plugin-Agent_Card_Info';
...
$Agent_Card_Info_options = new Agent_Card_Info_options();
$Agent_Card_Info_options->init();