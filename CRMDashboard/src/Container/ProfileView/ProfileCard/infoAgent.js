        ...
        <Box className={classes.avatarContainer}>
          ...
          <Box className={classes.agentName}>
            <Text transform="capitalize" component="h4">
              {concat(
                get(dataAgent, ["firstName"], ""),
                " ",
                get(dataAgent, ["lastName"], "")
              )}
            </Text>
            <Text transform="capitalize" component="span">
              {get(dataAgent, ["position"], "")}
            </Text>
          </Box>
        </Box>
      ...
      <Box className={classes.infoContact}>
        ...
        <Box className={classes.infoItem}>
          <CustomIconTooltip
            size={24}
            color="secondary"
            labelTooltip={get(dataAgent, ["email"], "")}
          >
            <Mail />
          </CustomIconTooltip>
          <Text transform="lowercase" component="span">
            {get(dataAgent, ["email"], "")}
          </Text>
        </Box>
        <Box className={classes.infoItem}>
          <CustomIconTooltip
            size={24}
            color="secondary"
            labelTooltip={get(dataAgent, ["phone"], "")}
          >
            <Phone />
          </CustomIconTooltip>
        ...
        <Box className={classes.infoSocialMedia}>
          {startsWith(socialMedia.twitter, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.twitter}
            >
              <BrandTwitter />
            </CustomIconTooltip>
          )}
          ...
          {startsWith(socialMedia.facebook, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.facebook}
            >
              <BrandFacebook />
            </CustomIconTooltip>
          )}
          ...
          {startsWith(socialMedia.instagram, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.instagram}
            >
              <BrandInstagram />
            </CustomIconTooltip>
          )}
          ...
          {startsWith(socialMedia.linkedin, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.linkedin}
            >
              <BrandLinkedin />
            </CustomIconTooltip>
          )}
          ...
          {startsWith(socialMedia.tiktok, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.tiktok}
            >
              <BrandTiktok />
            </CustomIconTooltip>
          )}
          ...
          {startsWith(socialMedia.youtube, "https") && (
            <CustomIconTooltip
              size={24}
              color="secondary"
              labelTooltip={socialMedia.youtube}
            >
              <BrandYoutube />
            </CustomIconTooltip>
          )}
