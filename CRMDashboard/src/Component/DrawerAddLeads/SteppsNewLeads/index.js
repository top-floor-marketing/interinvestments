...
const SteppsNewLeads = (_) => {
  ...
  const nextStep = () =>
    setstepperActive(stepperActive < 3 ? stepperActive + 1 : stepperActive);
        ...
        >
          <Stepper {...props.Stepper}>
            <Stepper.Step
              ...
              label={
                <Text component="span" className={classes.titleStep}>
                  Step 2
                </Text>
              }
              description={
