...
class CRM_Dashboard_options
{
  ...
  {
    $this->plugin_options_page = add_options_page('CRM_Dashboard', 'CRM_Dashboard', 'manage_options', __FILE__, array($this, 'render_plugin_options_page'));
  }

  public function render_plugin_options_page()
  {
    echo '<div id="CRM_Dashboard"></div>';
  }
...
$CRM_Dashboard_options = new CRM_Dashboard_options();
$CRM_Dashboard_options->init();
